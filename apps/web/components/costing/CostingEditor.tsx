...
import { BackIcon, CameraIcon, Plus } from '@/components/shell/icons';
              ...
              {rows.map((r, i) => {
                ...
                return (
                  <div key={r.id} className={`${COLS} border-b border-black/[0.05]`}>
                    ...
                    <input className={`${cell} ${div} text-right num`} type="number" step="0.01" value={r.cost_unit} onChange={e => patchRow(r.id, { cost_unit: Number(e.target.value) || 0 })} />
